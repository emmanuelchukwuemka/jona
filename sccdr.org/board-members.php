                ...
                <div class="row align-items-center">
                    <div class="col-10 text-center offset-1">
                        <div class="hero-content-wrapper">
                            ...
                            <p>
                            <a href="index.php" style="color:#7AD03A;">Home</a> / <span style="color:#ffffff;"> BOARD MEMBERS</span>
        ...
        <footer class="footer pt-50 img-bg" style="background-image: url('https://res.cloudinary.com/ecrtechdev/image/upload/v1654379913/ecrts/common-bg_vjsbxc.png')">
            <div class="container">
                ...
                <div class="copyright-area">
                    <p class="mb-0 text-white text-center">© <a href="board-members.php#" rel="nofollow" target="_blank">sccdr.org</a> 2022, All Rights Reserved.  </p>
                </div>
            </div>
        </footer>

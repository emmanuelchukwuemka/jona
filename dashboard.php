            ...
            <div class="member-section" id="section-submit-abstract">
                <div class="section-card" style="max-width: 720px;">
                    ...
                    <form id="abstractForm" onsubmit="submitAbstract(event)">
                        ...
                        <div class="form-group">
                            <label class="form-label">Abstract Text <span style="font-size:11px; color:#94a3b8;">(Optional if uploading a file)</span></label>
                            <textarea name="abstract_text" class="form-control" rows="8" placeholder="Enter your full abstract here..."></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Upload Abstract File <span style="font-size:11px; color:#94a3b8;">(Optional, .pdf, .doc, .docx only)</span></label>
                            <input type="file" name="abstract_file" class="form-control" accept=".pdf,.doc,.docx">
                            <p style="font-size:11px; color:#64748b; margin-top:5px;">Note: You can submit either text, a file, or both.</p>
                        </div>
                    ...
                    <div class="abstracts-grid">
                        ...
                        <div class="abstract-card status-<?= $ab['status'] ?>">
                            ...
                            <div class="abstract-meta">
                                ...
                                <?php if($ab['file_path']): ?>
                                <a href="<?= htmlspecialchars($ab['file_path']) ?>" target="_blank" style="margin-left:auto; font-size:11px; color:#3b82f6; font-weight:700; text-decoration:none;">

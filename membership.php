    ...
    <div class="col-lg-7 d-flex align-items-center justify-content-center" style="padding: 60px 40px;">
        ...
        <div style="width: 100%; max-width: 550px;">
            ...
            <div class="text-center mb-40">
                <h2 style="font-weight: 800; color: var(--heading-color); margin-bottom: 5px; font-size: 32px;">Welcome to SCCDR</h2>
                <div style="font-size: 14px; color: #7AD03A; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 15px;">Society for Community & Communication Development Research</div>
